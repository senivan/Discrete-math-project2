from PyQt5.QtWidgets import QApplication, QWidget, QGraphicsDropShadowEffect, QVBoxLayout, QLabel, QLineEdit, QPushButton, QMessageBox
...
class MainWindow(QWidget):
    def __init__(self) -> None:
        ...
        self.shadow = QGraphicsDropShadowEffect()
        self.shadow.setBlurRadius(20)
        self.user_cred = self.load_creds()
        self.shadow.setXOffset(0)
        self.shadow.setYOffset(0)
        self.shadow.setColor(QtCore.Qt.GlobalColor.black)
        self.setGraphicsEffect(self.shadow)
    ...
    def load_creds(self):
        ...
        if not os.path.exists("client_secret.json"):
            ...
            loop.exec()
        username, password = json.load(open("client_secret.json", "r"))
